...
function Comment(props) {
	...
	const updateComment = async () => {
		...
		await axios.patch(`${process.env.REACT_APP_API_URL}/board/${boardId}/comment/update/${commentId}`, req, {headers: headers})
		.then((resp) => {
	...
	const deleteComment = async () => {
		await axios.delete(`${process.env.REACT_APP_API_URL}/board/${boardId}}/comment/delete/${commentId}`, {headers: headers})
			.then((resp) => {
